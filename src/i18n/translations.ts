...
const en: Translations = {
    ...
    nav: {
      ...
      footerAdsCollabs: "Ads & collabs",
      footerDescription: "RoxStreamAI helps creators run AI-hosted streams with clear usage limits and Unreal-ready workflows.",
    ...
    marketing: {
      ...
      contactTopicSecurity: "Security",
      contactFormSending: "Sending...",
      contactFormSuccess: "Thanks. We received your message and will reply by email.",
      contactPartnerships: "Partnerships",
      contactTechNote: "For technical issues, include your Diagnostics screenshot and Desktop logs path.",
    },
    app: {
      overview: "Overview",
...
export const translations: Record<Locale, Translations> = {
  ...
  cs: {
    ...
    nav: {
      ...
      footerLegal: "Právní",
      footerDownload: "Stáhnout",
      footerAdsCollabs: "Reklama a spolupráce",
      footerDescription: "RoxStreamAI pomáhá tvůrcům provozovat AI streamy s jasnými limity a Unreal workflow.",
    ...
    marketing: {
      ...
      contactFormTopic: "Téma",
      contactTopicSupport: "Podpora",
      contactTopicPartnership: "Partnerství",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Bezpečnost",
      contactFormSending: "Odesílání...",
      contactFormSuccess: "Díky. Zprávu jsme obdrželi a odpovíme e-mailem.",
      contactPartnerships: "Partnerství",
      contactTechNote: "Pro technické problémy přiložte screenshot Diagnostics a cestu k logům Desktop aplikace.",
    },
    app: {
      overview: "Prehled",
  ...
  pl: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Reklama i współpraca",
      footerDescription: "RoxStreamAI pomaga twórcom prowadzić streamy AI z jasnymi limitami i workflow Unreal.",
    ...
    marketing: {
      ...
      contactTopicSupport: "Wsparcie",
      contactTopicPartnership: "Partnerstwo",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Bezpieczeństwo",
      contactFormSending: "Wysyłanie...",
      contactFormSuccess: "Dziękujemy. Otrzymaliśmy wiadomość i odpowiemy e-mailem.",
      contactPartnerships: "Partnerstwa",
      contactTechNote: "W przypadku problemów technicznych dołącz zrzut ekranu Diagnostics i ścieżkę do logów Desktop.",
    },
    app: {
      overview: "Przeglad",
  ...
  sk: {
    ...
    nav: {
      ...
      footerLegal: "Právne",
      footerDownload: "Stiahnuť",
      footerAdsCollabs: "Reklama a spolupráca",
      footerDescription: "RoxStreamAI pomáha tvorcom prevádzkovať AI streamy s jasnými limitmi a Unreal workflow.",
      footerCopyright: "Všetky práva vyhradené.",
    },
    auth: {
    ...
    marketing: {
      ...
      contactFormTopic: "Téma",
      contactTopicSupport: "Podpora",
      contactTopicPartnership: "Partnerstvo",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Bezpečnosť",
      contactFormSending: "Odosielanie...",
      contactFormSuccess: "Ďakujeme. Správu sme prijali a odpovieme e-mailom.",
      contactPartnerships: "Partnerstvá",
      contactTechNote: "Pri technických problémoch priložte snímku obrazovky Diagnostics a cestu k logom Desktop aplikácie.",
    },
    app: {
      overview: "Prehlad",
  ...
  de: {
    ...
    nav: {
      ...
      footerDownload: "Download",
      footerAdsCollabs: "Werbung & Kooperationen",
      footerDescription: "RoxStreamAI hilft Creatorn, KI-gestützte Streams mit klaren Nutzungslimits und Unreal-Workflows zu betreiben.",
    ...
    marketing: {
      ...
      contactFormName: "Name",
      contactFormTopic: "Thema",
      contactTopicSupport: "Support",
      contactTopicPartnership: "Partnerschaft",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Sicherheit",
      contactFormSending: "Wird gesendet...",
      contactFormSuccess: "Danke. Wir haben Ihre Nachricht erhalten und antworten per E-Mail.",
      contactPartnerships: "Partnerschaften",
      contactTechNote: "Bei technischen Problemen fügen Sie bitte einen Diagnostics-Screenshot und den Pfad zu den Desktop-Logs bei.",
    },
    app: {
      overview: "Übersicht",
  ...
  es: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Publicidad y colaboraciones",
      footerDescription: "RoxStreamAI ayuda a creadores a ejecutar streams con IA, con límites claros y flujos Unreal.",
    ...
    marketing: {
      ...
      contactFormTopic: "Tema",
      contactTopicSupport: "Soporte",
      contactTopicPartnership: "Colaboración",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Seguridad",
      contactFormSending: "Enviando...",
      contactFormSuccess: "Gracias. Hemos recibido tu mensaje y responderemos por correo.",
      contactPartnerships: "Colaboraciones",
      contactTechNote: "Para problemas técnicos, incluye una captura de Diagnostics y la ruta de los logs de Desktop.",
    },
    app: {
      overview: "Resumen",
  ...
  fr: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Publicité et collaborations",
      footerDescription: "RoxStreamAI aide les créateurs à diffuser des streams IA avec des limites claires et des workflows Unreal.",
    ...
    marketing: {
      ...
      contactTopicSupport: "Support",
      contactTopicPartnership: "Partenariat",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Sécurité",
      contactFormSending: "Envoi en cours...",
      contactFormSuccess: "Merci. Nous avons reçu votre message et répondrons par e-mail.",
      contactPartnerships: "Partenariats",
      contactTechNote: "Pour les problèmes techniques, joignez une capture Diagnostics et le chemin des logs Desktop.",
    },
    app: {
      overview: "Aperçu",
      ...
      notificationsSubtitle: "Utilisation, bonus et mises à jour de facturation.",
    ...
    admin: {
      ...
      overviewSubtitle:
        "Totaux clés des utilisateurs, espaces de travail, facturation et usage.",
      totalUsers: "Total utilisateurs",
      totalUsersHelp: "Profils créés dans Supabase.",
      workspaces: "Espaces de travail",
      workspacesHelp: "Total des espaces de travail de tous les utilisateurs.",
  ...
  it: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Pubblicità e collaborazioni",
      footerDescription: "RoxStreamAI aiuta i creator a gestire stream AI con limiti chiari e workflow Unreal.",
    ...
    marketing: {
      ...
      contactFormTopic: "Argomento",
      contactTopicSupport: "Supporto",
      contactTopicPartnership: "Partnership",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Sicurezza",
      contactFormSending: "Invio in corso...",
      contactFormSuccess: "Grazie. Abbiamo ricevuto il messaggio e risponderemo via email.",
      contactPartnerships: "Partnership",
      contactTechNote: "Per problemi tecnici, allega uno screenshot di Diagnostics e il percorso dei log Desktop.",
    },
    app: {
      overview: "Panoramica",
  ...
  pt: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Publicidade e colaborações",
      footerDescription: "RoxStreamAI ajuda criadores a realizar streams com IA, com limites claros e workflows Unreal.",
    ...
    marketing: {
      ...
      contactFormName: "Nome",
      contactFormTopic: "Assunto",
      contactTopicSupport: "Suporte",
      contactTopicPartnership: "Parceria",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Segurança",
      contactFormSending: "Enviando...",
      contactFormSuccess: "Obrigado. Recebemos sua mensagem e responderemos por e-mail.",
      contactPartnerships: "Parcerias",
      contactTechNote: "Para problemas técnicos, inclua uma captura de tela do Diagnostics e o caminho dos logs Desktop.",
    },
    app: {
  ...
  ru: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Реклама и коллаборации",
      footerDescription: "RoxStreamAI помогает креаторам запускать AI-стримы с понятными лимитами и Unreal-совместимыми процессами.",
    ...
    marketing: {
      ...
      contactTopicSupport: "Поддержка",
      contactTopicPartnership: "Партнёрство",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Безопасность",
      contactFormSending: "Отправляем...",
      contactFormSuccess: "Спасибо! Мы получили сообщение и ответим по email.",
      contactPartnerships: "Партнёрства",
      contactTechNote: "Для техподдержки приложите скриншот Diagnostics и путь к логам Desktop приложения.",
    },
    app: {
      overview: "Обзор",
  ...
  tr: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Reklam ve iş birlikleri",
      footerDescription: "RoxStreamAI, içerik üreticilerinin net kullanım limitleri ve Unreal iş akışlarıyla AI destekli yayın yapmasına yardımcı olur.",
    ...
    marketing: {
      ...
      contactFormTopic: "Konu",
      contactTopicSupport: "Destek",
      contactTopicPartnership: "Ortaklık",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Güvenlik",
      contactFormSending: "Gönderiliyor...",
      contactFormSuccess: "Teşekkürler. Mesajınızı aldık ve e-posta ile yanıtlayacağız.",
      contactPartnerships: "Ortaklıklar",
      contactTechNote: "Teknik sorunlar için Diagnostics ekran görüntüsü ve Desktop log yolunu ekleyin.",
    },
    app: {
  ...
  uk: {
    ...
    nav: {
      ...
      footerAdsCollabs: "Реклама та співпраця",
      footerDescription: "RoxStreamAI допомагає креаторам запускати AI-стріми з чіткими лімітами та Unreal-сумісними процесами.",
    ...
    marketing: {
      ...
      contactFormTopic: "Тема",
      contactTopicSupport: "Підтримка",
      contactTopicPartnership: "Партнерство",
      contactTopicSales: "Sales",
      contactTopicSecurity: "Безпека",
      contactFormSending: "Відправляємо...",
      contactFormSuccess: "Дякуємо! Ми отримали повідомлення і відповімо на email.",
      contactPartnerships: "Партнерства",
      contactTechNote: "Для технічної підтримки додайте знімок екрана Diagnostics та шлях до логів Desktop застосунку.",
    },
    app: {
      overview: "Огляд",
