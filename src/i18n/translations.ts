...
const en: Translations = {
    ...
    app: {
      ...
      notificationsTitle: "Centre d'alertes",
      ...
      characterEditorSectionTitle: "Duzenleyici",
      ...
      unrealConnector: "Unreal Baglanti",
      ...
      unrealRuntimeConnectorTitle: "Unreal Runtime Baglantisi",
      ...
      characterBuilderNotesTitle: "Remarques",
    ...
    admin: {
      ...
      pricingVersions: "Versions tarifaires",
      ...
      pricingTablePlan: "Forfait",
      pricingTableMonthlyEur: "Monthly (€)",
      pricingTableEntitlementsJson: "Droits (JSON)",
...
export const translations: Record<Locale, Translations> = {
  ...
  de: {
    ...
    admin: {
      ...
      overviewSubtitle:
        "Totales clave de usuarios, workspaces, facturación y uso.",
      totalUsers: "Total de usuarios",
      totalUsersHelp: "Perfiles creados en Supabase.",
      workspaces: "Arbeitsbereiche",
      workspacesHelp: "Total de workspaces de todos los usuarios.",
      activeSubscriptions: "Suscripciones activas",
      activeSubscriptionsHelp: "Filas de billing_state con status=active.",
      usageEvents24h: "Eventos de uso (24h)",
      usageEvents24hHelp: "Eventos ingeridos en las últimas 24 horas.",
      releasesCount: "Lanzamientos",
      releasesCountHelp: "Builds de escritorio disponibles para descargar.",

      usersTitle: "Gestionar acceso",
      usersSubtitle: "Actualiza el rol y plan del usuario.",
      tableEmail: "E-Mail",
      tableRole: "Rol",
      tablePlan: "Tarifa",
      tableCreated: "Creado",
      ...
      pricingSubtitle:
        "Edita la configuración versionada de precios y publica la versión activa.",
      contentTitle: "CMS de marketing",
      contentSubtitle:
        "Edita el texto de marketing con bloques markdown. Las páginas se cargan por clave con fallbacks.",
      leadsTitle: "Lista de espera y contacto",
      leadsSubtitle: "Ver leads capturados y exportar CSV.",
      auditTitle: "Logs de auditoría",
      auditSubtitle:
      ...
      pricingNoVersions: "Aún no hay versiones.",
      pricingEditor: "Bearbeitung",
      pricingEditingVersion: "Editando v{version}",
      pricingSelectVersion: "Selecciona una versión",
      pricingRawJsonAdvanced: "JSON crudo (avanzado)",
      pricingYearlyDiscountPct: "Descuento anual (%)",
      pricingDefaultTalkRatio: "Talk ratio predeterminado",
      pricingMinTalkRatio: "Talk ratio mínimo",
      pricingMaxTalkRatio: "Talk ratio máximo",
      ...
      pricingPlaceholderEntitlementsJson: "{\n  \"max_characters\": 1,\n  \"...\": \"...\"\n}",
      pricingTipValidation:
        "Tip: al guardar se valida el esquema del lado del servidor.",

      contentSearchPlaceholder: "Buscar claves o texto…",
      contentNoBlocks: "Aún no hay bloques de contenido.",
      ...
      leadsNoLeads: "Aún no hay leads.",

      auditFilterActionPlaceholder: "Filtrar acción…",
      ...
      auditNoEntries: "Aún no hay entradas de auditoría.",

      releasesVersion: "Versión",
      releasesPlatform: "Plataforma",
      releasesDownloadUrl: "URL de descarga",
      releasesNotes: "Notas",
      releasesMarkLatest: "Marcar como latest",
