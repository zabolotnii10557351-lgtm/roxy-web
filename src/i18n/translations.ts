...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    marketing: {
      ...
      heroTitle: "Launch AI streamers in 10 minutes",
      heroSubtitle:
        "RoxStreamAI is a web dashboard and desktop companion app for AI streamers. Build characters, choose voice and brain providers, control Active Speech, and connect to Unreal for a real-time avatar.",
      demoPrimary: "Download Demo",
      demoSecondary: "Open Dashboard",
      demoNote: "Transparent usage limits. Predictable cost. BYOK supported.",
      howItWorksTitle: "How it works",
      howItWorksSubtitle: "Create a character, set limits, connect Unreal, and go live.",
      featuresTitle: "What you get",
      featuresSubtitle: "Operational tools for AI streamer workflows.",
      useCasesTitle: "Use cases",
      useCasesSubtitle: "Real formats RoxStreamAI is built for.",
      ctaTitle: "Transparent usage, predictable cost",
      ctaSubtitle:
        "You control Active Speech and concurrency. The dashboard shows estimated hours and cost before you go live. Use built-in providers or BYOK when you want maximum control.",
      ctaPrimary: "Download Desktop App",
