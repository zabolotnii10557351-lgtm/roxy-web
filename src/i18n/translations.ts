...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    marketing: {
      ...
      heroTitle: "RoxStreamAI launches AI streamers in 10 minutes.",
      heroSubtitle:
        "RoxStreamAI reads chat, reacts to gifts, runs show scripts, and streams 24/7 with safety guardrails. Built for TikTok Live today, Twitch and YouTube next.",
      demoPrimary: "Download Demo",
      demoSecondary: "Watch 45s Demo",
      demoNote:
        "Pro plan works out of the box with included credits. Basic supports BYOK.",
      howItWorksTitle: "From zero to live in three moves",
      howItWorksSubtitle:
        "Everything you need to launch a controllable AI streamer.",
      featuresTitle: "Automation that feels premium",
      featuresSubtitle:
        "Designed for retention loops, safety, and long sessions.",
      useCasesTitle: "Built for modern live formats",
      useCasesSubtitle:
        "One platform for creators, faceless formats, and agencies.",
      ctaTitle: "Ready to see it in action?",
      ctaSubtitle: "Start with a free trial or compare plans in minutes.",
      ctaPrimary: "Start Free Trial",
      ctaSecondary: "View Pricing",
      faqTitle: "Fast answers before you go live",
      faqSubtitle: "Everything you need to know about plans and usage.",
    },
    app: {
      overview: "Overview",
      overviewSubtitle: "Live status, limits, and quick actions.",
      ...
      billing: "Billing",
      billingSubtitle: "Manage your plan, credits, and add-ons.",
      ...
      settings: "Settings",
      settingsSubtitle: "Control workspace preferences and export tools.",
      characters: "Characters",
      charactersSubtitle: "Manage your AI streamer personas.",
      noCharacters: "No characters yet. Create your first AI streamer persona.",
  ...
  ru: {
    ...
    marketing: {
      heroBadge: "RoxStreamAI",
      heroTitle: "RoxStreamAI запускает AI-стримеров за 10 минут.",
      heroSubtitle:
        "RoxStreamAI читает чат, реагирует на подарки, ведет сценарии и стримит 24/7 с безопасными ограничителями. TikTok Live сегодня, Twitch и YouTube дальше.",
      demoPrimary: "Скачать демо",
      demoSecondary: "Смотреть 45с демо",
      demoNote:
        "Pro-тариф работает сразу с включенными кредитами. Basic поддерживает BYOK.",
      howItWorksTitle: "От нуля до эфира за три шага",
      howItWorksSubtitle:
        "Все, что нужно для запуска управляемого AI-стримера.",
      featuresTitle: "Автоматизация уровня премиум",
      featuresSubtitle:
        "Для удержания, безопасности и длинных сессий.",
