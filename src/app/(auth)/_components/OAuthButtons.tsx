...
export default function OAuthButtons() {
  ...
  const handleOAuth = async (provider: "google" | "discord" | "twitch") => {
    setLoading(provider);
    setError(null);
      ...
      <div className="flex gap-3">
        {providers.map((p) => (
          <button
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white transition hover:bg-white/10 disabled:opacity-50"
          >
            {loading === p.id ? (
